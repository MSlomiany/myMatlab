classdef utility
    ...
    methods(Static)
        ...
        function [] = init(varargin)
            ...
            if (nargin == 0)
                set(groot,'defaultFigureWindowState','maximized'); % figura
                set(groot,'defaultAxesXGrid','on','defaultAxesYGrid','on','defaultAxesNextPlot','add'); % wykre
                set(groot,'defaultAxesTickLabelInterpreter','latex','defaultAxesLabelFontSizeMultiplier',1.5); % osie
                set(groot,'defaultAxesTitleFontSizeMultiplier',2,'defaultTextInterpreter','latex'); % tytuł
